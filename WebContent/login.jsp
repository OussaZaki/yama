...
<link rel="stylesheet"
	href="/YamaWeb/css/bootstrap-tagmanager.css">
<style type="text/css">
body {
	padding-top: 60px;
}
...
<link rel="stylesheet"
	href="/YamaWeb/css/bootstrap-responsive.min.css">
	
<script src="/YamaWeb/js/tagcanvas.min.js" type="text/javascript"></script>
...
<body>
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="navbar-inner">
			<div class="container">
				<a href="/YamaWeb/" class="brand">YAMA  - You Ask, Moroccans Answer</a>
			</div>
		</div>
	</div>
				...
				<div class="tab-content">
					<div class="tab-pane active span3" id="login">
						<form name="form1" method="post"
							action="/YamaWeb/User/loginAction">
					...
					<div class="tab-pane span3" id="register">
						<form name="form2" method="post"
							action="/YamaWeb/User/registerAction">
							<input class="FormText" type="hidden" name="clickedButton"
	...
	<script type="text/javascript"
		src="/YamaWeb/js/bootstrap-alert.js"></script>
	<script type="text/javascript"
		src="/YamaWeb/js/bootstrap-tagmanager.js"></script>
	<script>
